      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            <h4 className="text-white font-bold mb-6">Services</h4>
            <ul className="space-y-4">
              <li><Link to="/services#ai-chatbots" className="footer-link">Custom AI Chatbot Development</Link></li>
              <li><Link to="/services#ai-automation" className="footer-link">AI Automation Workflows</Link></li>
              ...
              <li><Link to="/services#crm" className="footer-link">CRM (Customer Relationship Management)</Link></li>
              <li><Link to="/services#ai-voice-agents" className="footer-link">AI Voice Agents</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            {/* Email */}
            <div className="flex items-start gap-3 text-gray-400 text-sm mb-4">
              <Mail size={16} className="text-cyan-400 mt-1" />
              <a
                href="mailto:digixea1@gmail.com"
                className="hover:text-white transition-colors"
              >
            ...
            {/* Phone */}
            <div className="flex items-start gap-3 text-gray-400 text-sm mb-4">
              <Phone size={16} className="text-cyan-400 mt-1" />
              <a
                href="tel:+917070187174"
                className="hover:text-white transition-colors"
              >
                +91-7070187174
              </a>
            ...
            <div className="flex items-start gap-3 text-gray-400 text-sm leading-relaxed">
              ...
              <span>
                17th Floor, Celestial Apartment,  
                Tank Road, Bhandup,  
                Mumbai (MH) – 400078
              </span>
            </div>
